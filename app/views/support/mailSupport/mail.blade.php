...
<div class="row">
	...
	<div class="col-sm-9 col-md-10">
		...
		<button type="button" data-toggle="tooltip" title="" class="btn btn-default mls mrs" data-original-title="Refresh"><span class="fa fa-refresh"></span></button>
		<div class="btn-group">
...
<div class="col-sm-3 col-md-2 block-space"><a href="#" role="button" class="btn btn-danger btn-sm btn-block">COMPOSE</a>
	...
	<div class="panel">
		<div class="panel-body pan">
			<ul style="background: #fff" class="nav nav-pills nav-stacked element">
