<header>
      ...
      <ul class="newsticker list-unstyled ml-15 mb-0 pull-left visible-lg" style="height: 64px; overflow: hidden;"><li class="fw-500" style="margin-top: 0px;">You <span class="text-danger">recommended</span> Karen Ortega.</li><li class="fw-500" style="margin-top: 0px;">You <span class="text-info">followed</span> Olivia Williamson.</li><li class="fw-500" style="margin-top: 0px;">New product <span class="text-success">Microsoft Lumia 950XL</span></li><li class="fw-500" style="margin-top: 0px;">New order <span class="text-success">#021930217965</span></li>
      ...
      <ul class="notification-bar list-inline pull-right">
        ...
        <li class="dropdown"><a id="dropdownMenu1" href="#" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false" class="dropdown-toggle bubble header-icon"><i class="ti-save text-muted"></i><span class="badge bg-danger">3</span></a>
          <div aria-labelledby="dropdownMenu1" class="dropdown-menu dropdown-menu-right dm-medium fs-12 fadeInDown animated" style="animation-duration: 0.2s; animation-delay: 0s; animation-timing-function: linear; animation-iteration-count: 1;">
            <h5 class="dropdown-header">You have 3 file downloads</h5>
            <ul data-mcs-theme="minimal-dark" class="media-list mCustomScrollbar _mCS_1 mCS-autoHide mCS_no_scrollbar" style="position: relative; overflow: visible;"><div id="mCSB_1" class="mCustomScrollBox mCS-minimal-dark mCSB_vertical mCSB_outside" style="max-height: 0px;" tabindex="0"><div id="mCSB_1_container" class="mCSB_container mCS_y_hidden mCS_no_scrollbar_y" style="position:relative; top:0; left:0;" dir="ltr">
        ...
        <li class="dropdown"><a id="dropdownMenu2" href="#" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false" class="dropdown-toggle bubble header-icon"><i class="ti-world text-muted"></i><span class="badge bg-danger">6</span></a>
          <div aria-labelledby="dropdownMenu2" class="dropdown-menu dropdown-menu-right dm-medium fs-12 fadeInDown animated" style="animation-duration: 0.2s; animation-delay: 0s; animation-timing-function: linear; animation-iteration-count: 1;">
            <h5 class="dropdown-header">You have 6 notifications</h5>
            <ul data-mcs-theme="minimal-dark" class="media-list mCustomScrollbar _mCS_2 mCS-autoHide mCS_no_scrollbar" style="position: relative; overflow: visible;"><div id="mCSB_2" class="mCustomScrollBox mCS-minimal-dark mCSB_vertical mCSB_outside" style="max-height: 0px;" tabindex="0"><div id="mCSB_2_container" class="mCSB_container mCS_y_hidden mCS_no_scrollbar_y" style="position:relative; top:0; left:0;" dir="ltr">
              <li class="media"><a href="javascript:;">
                  <div class="media-left avatar"><img src="build/images/users/17.jpg" alt="" class="media-object img-circle mCS_img_loaded"><span class="status bg-warning"></span></div>
                  <div class="media-body">
              ...
              <li class="media"><a href="javascript:;">
                  <div class="media-left avatar"><img src="build/images/users/19.jpg" alt="" class="media-object img-circle mCS_img_loaded"><span class="status bg-danger"></span></div>
                  <div class="media-body">
              ...
              <li class="media"><a href="javascript:;">
                  <div class="media-left avatar"><img src="build/images/users/11.jpg" alt="" class="media-object img-circle mCS_img_loaded"><span class="status bg-danger"></span></div>
                  <div class="media-body">
              ...
              <li class="media"><a href="javascript:;">
                  <div class="media-left avatar"><img src="build/images/users/12.jpg" alt="" class="media-object img-circle mCS_img_loaded"><span class="status bg-success"></span></div>
                  <div class="media-body">
              ...
              <li class="media"><a href="javascript:;">
                  <div class="media-left avatar"><img src="build/images/users/13.jpg" alt="" class="media-object img-circle mCS_img_loaded"><span class="status bg-warning"></span></div>
                  <div class="media-body">
            ...
            </div></div><div id="mCSB_2_scrollbar_vertical" class="mCSB_scrollTools mCSB_2_scrollbar mCS-minimal-dark mCSB_scrollTools_vertical" style="display: none;"><div class="mCSB_draggerContainer"><div id="mCSB_2_dragger_vertical" class="mCSB_dragger" style="position: absolute; min-height: 50px; top: 0px; display: block; height: 141px; max-height: 202px;" oncontextmenu="return false;"><div class="mCSB_dragger_bar" style="line-height: 50px;"></div></div><div class="mCSB_draggerRail"></div></div></div></ul>
