<div class="main-container">
      ...
      <aside data-mcs-theme="minimal-dark" class="main-sidebar mCustomScrollbar _mCS_2 mCS-autoHide" style="overflow: visible;"><div id="mCSB_2" class="mCustomScrollBox mCS-minimal-dark mCSB_vertical mCSB_outside" style="max-height: none;" tabindex="0"><div id="mCSB_2_container" class="mCSB_container" style="position: relative; top: 0px; left: 0px;" dir="ltr">
        ...
        <ul class="list-unstyled navigation mb-0">
          ...
          <li><a href="widgets.html"><i class="ti-panel"></i> Widgets <span class="label label-outline label-danger">New</span></a></li>
          ...
          <li class="panel"><a role="button" data-toggle="collapse" data-parent=".navigation" href="#collapse18" aria-expanded="true" aria-controls="collapse18" class="active"><i class="ti-panel"></i> Apps</a>
            <ul id="collapse18" class="list-unstyled collapse in">
              <li><a href="mailbox.html" class="active">Mailbox</a></li>
        ...
        <ul class="list-unstyled pl-20 pr-20">
          ...
          <li class="mb-20">
            ...
            <div class="progress progress-xs mb-0">
              <div role="progressbar" data-transitiongoal="80" class="progress-bar progress-bar-danger" aria-valuenow="80" style="width: 80%;"></div>
            </div>
          </li>
        </ul>
      </div></div><div id="mCSB_2_scrollbar_vertical" class="mCSB_scrollTools mCSB_2_scrollbar mCS-minimal-dark mCSB_scrollTools_vertical" style="display: block;"><div class="mCSB_draggerContainer"><div id="mCSB_2_dragger_vertical" class="mCSB_dragger" style="position: absolute; min-height: 50px; display: block; height: 42px; max-height: 303px; top: 0px;" oncontextmenu="return false;"><div class="mCSB_dragger_bar" style="line-height: 50px;"></div></div><div class="mCSB_draggerRail"></div></div></div></aside>
      <!-- Main Sidebar end-->
      ...
      <aside class="right-sidebar closed">
          ...
          <div id="chat" role="tabpanel" class="tab-pane fade in active">
            ...
            <ul class="chat-list mb-0 fs-12 media-list">
              <li class="media"><a href="javascript:;" class="conversation-toggle">
                  <div class="media-left avatar"><img src="../build/images/users/20.jpg" alt="" class="media-object img-circle mCS_img_loaded"><span class="status bg-success"></span></div>
                  <div class="media-body">
              ...
              <li class="media"><a href="javascript:;" class="conversation-toggle">
                  <div class="media-left avatar"><img src="../build/images/users/01.jpg" alt="" class="media-object img-circle mCS_img_loaded"><span class="status bg-success"></span></div>
                  <div class="media-body">
                    <h6 class="media-heading">Edward Garcia</h6>
                    <p class="text-muted mb-0">Nice to meet you.</p>
                  </div></a></li>
              <li class="media"><a href="javascript:;" class="conversation-toggle">
                  <div class="media-left avatar"><img src="../build/images/users/02.jpg" alt="" class="media-object img-circle mCS_img_loaded"><span class="status bg-success"></span></div>
                  <div class="media-body">
                    <h6 class="media-heading">Bruce Olson</h6>
                    <p class="text-muted mb-0">What do you want to do?</p>
                  </div></a></li>
              <li class="media"><a href="javascript:;" class="conversation-toggle">
                  <div class="media-left avatar"><img src="../build/images/users/03.jpg" alt="" class="media-object img-circle mCS_img_loaded"><span class="status bg-warning"></span></div>
                  <div class="media-body">
              ...
              <li class="media"><a href="javascript:;" class="conversation-toggle">
                  <div class="media-left avatar"><img src="../build/images/users/05.jpg" alt="" class="media-object img-circle mCS_img_loaded"><span class="status bg-success"></span></div>
                  <div class="media-body">
                    <h6 class="media-heading">Hannah Williamson</h6>
                    <p class="text-muted mb-0">Do you know the address?</p>
                  </div></a></li>
              <li class="media"><a href="javascript:;" class="conversation-toggle">
                  <div class="media-left avatar"><img src="../build/images/users/06.jpg" alt="" class="media-object img-circle mCS_img_loaded"><span class="status bg-success"></span></div>
                  <div class="media-body">
                    <h6 class="media-heading">Anthony Mills</h6>
                    <p class="text-muted mb-0">No problem.</p>
                  </div></a></li>
              <li class="media"><a href="javascript:;" class="conversation-toggle">
                  <div class="media-left avatar"><img src="../build/images/users/07.jpg" alt="" class="media-object img-circle mCS_img_loaded"><span class="status bg-warning"></span></div>
                  <div class="media-body">
                    <h6 class="media-heading">Ethan Stanley</h6>
                    <p class="text-muted mb-0">Hello?</p>
                  </div></a></li>
              <li class="media"><a href="javascript:;" class="conversation-toggle">
                  <div class="media-left avatar"><img src="../build/images/users/08.jpg" alt="" class="media-object img-circle mCS_img_loaded"><span class="status bg-success"></span></div>
                  <div class="media-body">
                  ...
                  <div class="media-right"><span class="badge bg-danger">1</span></div></a></li>
              <li class="media"><a href="javascript:;" class="conversation-toggle">
                  <div class="media-left avatar"><img src="../build/images/users/09.jpg" alt="" class="media-object img-circle mCS_img_loaded"><span class="status bg-success"></span></div>
                  <div class="media-body">
                    <h6 class="media-heading">Denise Rose</h6>
                    <p class="text-muted mb-0">Bye bye.</p>
                  </div></a></li>
              <li class="media"><a href="javascript:;" class="conversation-toggle">
                  <div class="media-left avatar"><img src="../build/images/users/10.jpg" alt="" class="media-object img-circle mCS_img_loaded"><span class="status bg-danger"></span></div>
                  <div class="media-body">
        ...
        </div></div><div id="mCSB_3_scrollbar_vertical" class="mCSB_scrollTools mCSB_3_scrollbar mCS-minimal-dark mCSB_scrollTools_vertical" style="display: block;"><div class="mCSB_draggerContainer"><div id="mCSB_3_dragger_vertical" class="mCSB_dragger" style="position: absolute; min-height: 50px; display: block; height: 111px; max-height: 253px; top: 0px;" oncontextmenu="return false;"><div class="mCSB_dragger_bar" style="line-height: 50px;"></div></div><div class="mCSB_draggerRail"></div></div></div></div>
      </aside>
      <aside class="conversation closed">
        ...
        <ul data-mcs-theme="minimal-dark" class="media-list chat-content fs-12 pl-20 pr-20 mCustomScrollbar _mCS_4 mCS-autoHide" style="position: relative; overflow: visible;"><div id="mCSB_4" class="mCustomScrollBox mCS-minimal-dark mCSB_vertical mCSB_outside" style="max-height: none;" tabindex="0"><div id="mCSB_4_container" class="mCSB_container" style="position:relative; top:0; left:0;" dir="ltr">
          <li class="media">
            <div class="media-left avatar"><img src="../build/images/users/04.jpg" alt="" class="media-object img-circle mCS_img_loaded"><span class="status bg-success"></span></div>
            <div class="media-body">
              <p>Hello.</p>
          ...
          <li class="media other">
            ...
            <div class="media-right avatar"><img src="../build/images/users/18.jpg" alt="" class="media-object img-circle mCS_img_loaded"><span class="status bg-success"></span></div>
          </li>
          <li class="media">
            <div class="media-left avatar"><img src="../build/images/users/04.jpg" alt="" class="media-object img-circle mCS_img_loaded"><span class="status bg-success"></span></div>
            <div class="media-body">
