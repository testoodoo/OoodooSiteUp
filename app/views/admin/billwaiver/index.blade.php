...
<div class="breadcrumbs" id="breadcrumbs">
	...
	<ul class="breadcrumb">
		...
		<li class="active">
			<a href="/admin/billwaiver/index">Bill Waiver</a>
		</li>
	</ul>
</div>
<div class="page-header">
	<h1>
		Bill Waiver
		<a href="/admin/billwaiver/create" class="pull-right"><button class="btn btn-primary">Add New</button></a>
	</h1>
...
<script type="text/javascript">
	   jQuery(document).ready(function() {
            var oTable = jQuery('#sample-table-1').dataTable({
            	...
            	serverSide: true,
            	autoWidth: false,
                       "ajax": '/admin/billwaiver/index_ajax',
                       "type":'get',
