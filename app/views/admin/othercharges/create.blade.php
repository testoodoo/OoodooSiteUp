...
<div class="breadcrumbs" id="breadcrumbs">
	...
	<ul class="breadcrumb">
		...
		<li class="active">
			<a href="/admin/othercharges">Othercharages</a>
		</li>
		<li class="active">
			<a href="/admin/othercharges">Create</a>
		</li>
	</ul>
</div>
<div class="page-content">
	{{ Form::open( array( 'route' => array('admin.othercharges.store'), 'method' => 'POST','class' => 'form-horizontal validate-form', 'role' => 'form')  ) }}
	<div class="row">
		<div class="col-xs-12">
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					{{ Form::text('account_id', $othercharges->account_id , array('class' => 'col-xs-10 col-sm-5 account_id','required ')) }}
				</div>
			</div>
			<div class="form-group">
				{{ Form::label('amount','Amount', array('class' => 'col-sm-3 control-label no-padding-right'))}}
				<div class="col-sm-9">
					{{ Form::text('amount', $othercharges->amount , array('class' => 'col-xs-10 col-sm-5 digits','required ')) }}
				</div>
			</div>
			<div class="form-group">
