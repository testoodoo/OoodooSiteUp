...
<div class="breadcrumbs" id="breadcrumbs">
	...
	<ul class="breadcrumb">
		...
		<li class="active">
			<a href="/admin/othercharges">Othercharges</a>
		</li>
		<li class="active">
			<a href="/admin/othercharges">Index</a>
		</li>
	</ul>
</div>
<div class="page-header">
	<h1>
		Othercharges
		<a href="othercharges/create" class="pull-right"><button class="btn btn-primary">Add New</button></a>
	</h1>
</div>
