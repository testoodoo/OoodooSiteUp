					    ...
					    <div class="col-xs-12">
						    ...
						    <div class="update_meter{{$meter['id']}}">
								...
								<div class="form-group col-sm-12">
										...
										<div class="col-sm-1">
											<input type="text" name='drum_no[]'  placeholder='Drum No' class="form-control drum_no{{$meter['id']}}1"/>
										</div>	
										<div class="col-sm-1">		
											<input type="text" name='from_meter[]' placeholder='From Meter' class="form-control from_meter{{$meter['id']}}1"/>
										</div>
										<div class="col-sm-1">
											<input type="text" name='to_meter[]' placeholder='To Meter' class="form-control to_meter{{$meter['id']}}1"  onchange="TotalMeterCalc({{$meter['id']}},1)"/>
										</div>
										<div class="col-sm-1">
											<input type="text" name='total_meter[]' placeholder='Total Meter' class="form-control t_meter{{$meter['id']}}1" readonly="true"/>
										</div>
