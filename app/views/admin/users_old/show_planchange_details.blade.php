...
<div class="breadcrumbs" id="breadcrumbs">
	...
	<ul class="breadcrumb">
		...
		<li class="active">
			<a href="/admin/users-old/plan_change_details">Planchange</a>
		</li>
	</ul>
</div>
<div class="page-header">
	...
	<div  class="filters center">
        <a href="/admin/users-old/get_plan_change_details"  class="filters center"><button class="btn btn-primary">Add Planchange</button></a>
    </div>
</div>
...
<script type="text/javascript">
	   jQuery(document).ready(function() {
            var oTable = jQuery('#sample-table-1').dataTable({
    			processing: true,
            	serverSide: true,
                       "ajax": '/admin/users-old/ajax_plan_change_details',
                       "type":'get',
