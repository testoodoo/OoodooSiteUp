...
<div class="breadcrumbs" id="breadcrumbs">
    ...
    <ul class="breadcrumb">
        ...
        <li class="active">
            <a href="/admin/payments/pay-offline-bill">Off-line-bill</a>
        </li>
    </ul>
</div>
        ...
        <div class="col-xs-12">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-5" >
                        <select name="customer_type" class="form-control col-sm-6  select_payment_type required" style="width:340px;" required>
                            ...
                            <option value="planchange_topup">planchange topup details</option>
                        </select>
                    </div>
                    <a href="/admin/payments/due-offline-bill" class="btn btn-info">Due Payment</a>
                </div>
            </div>
            ...
            <div class="new_customers">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <span class="block input-icon input-icon-right">
                            <input type="text" class="col-xs-10 col-sm-5 required digits device_bill" readonly="readonly" name="bill_new_cust" value="300300" readonly>
                        </span>
                    </div>
                </div>
            </div>
                    ...
                    <div class="single_bill">
                        <div class="exit_customers">
                            ...
                            {{ Form::label('bill_no','bill no',array('class' => 'col-xs-12 col-sm-3 control-label no-padding-right '))}}
                                    <div class="col-sm-9">
                                        <span class="block input-icon input-icon-right">
                                            <input type="text" class="col-xs-10 col-sm-5 required digits billno bil_no" readonly="readonly" name="bill_no" value="">
                                        </span>
                                    </div>
                                </div>
                            </div>
