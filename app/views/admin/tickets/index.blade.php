...
<div class="breadcrumbs" id="breadcrumbs">
    ...
    <ul class="breadcrumb">
        ...
        <li class="active">
            <a href="/admin/ticket/index">Index</a>
        </li>
    </ul>
</div>
...
<div class="row">
        ...
        <span class="btn btn-app btn-info btn-xs"><p class="ace-icon fa bigger-110 ols"></p>open</span>
        <span class="btn btn-app btn-pink btn-xs"><p class="ace-icon fa bigger-110 cls"></p>close</span>
        <span class="btn btn-app btn-yellow btn-xs"><p class="ace-icon fa bigger-110 process"></p>process</span>
        <span class="btn btn-app btn-light  btn-xs"><p class="ace-icon fa bigger-110 invalid"></p>invalid</span>
...
<script type="text/javascript">
 jQuery(document).ready(function() {
            ...
            success : function(data){
                ...
                $('.invalid').text(data['invaild']);
                $('.trash').text(data['trash']);
            }
        });
    ...
    $('.findstatus').click(function(){
            ...
            var oTable = jQuery('#sample-table-1').dataTable({
                ...
                serverSide: true,
                autoWidth: false,
                       "ajax": '/admin/ticket/ajax_ticket?status='+status+'&area='+area+'&from='+from+'&to='+to,
                       "type":'get',
                       "lengthMenu": [[10,50,100,500,1000,-1], [10,50,100,500,1000,"All"]],
