...
use Input, Validator, Auth, Password, BaseController, View, Redirect, Lang, Hash, Employee, Mail;

class AuthController extends BaseController {

	protected $layout = 'admin._layouts.login';

	
	public function getLogin() {
		if( !Auth::check() ) {
			$this->layout->main = View::make('admin.auth.login');
		}
	...
	public function postLogin() {
		$credentials = array(
			'employee_identity'    => Input::get('employee_identity'),
